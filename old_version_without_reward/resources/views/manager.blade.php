                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form action="{{ route('create.points') }}" method="get">
                                    @csrf
                                    <input type="hidden" name="package" value="{{\App\Http\Controllers\FunctionsController::soonPackage()}}"/>
                                    <div class="card text-white bg-success">
                                        <div class="card-body">
                                            ...
                                            <input type="submit" style="background:transparent; border:none" class="card-link text-white" value="ایجاد" />
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form action="{{ route('update.points') }}" method="post">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input type="submit" style="background:transparent; border:none" class="card-link" value="ذخیره" />
                                    ...
                                    <form action="{{route('update.roles')}}" method="post">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <input type="submit" style="background:transparent; border:none" class="card-link"
                                                       value="ذخیره" />
                                            ...
                                            <form action="{{ route('update.customer') }}" method="post">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="role_id" class="form-select form-control" id="inputGroupSelect{{$item->customer_id}}">
                                                        @if(!empty(AppendRolesController::selectedManagerRole(\App\Http\Controllers\FunctionsController::soonPackage(), $item->customer_id)))
                                                            <option selected>--- {{AppendRolesController::selectedManagerRole(\App\Http\Controllers\FunctionsController::soonPackage(), $item->customer_id)->name}}</option>
                                                        @else
                                                ...
                                                <input type="submit" style="background:transparent; border:none" class="card-link" value="بروزرسانی" />
                                                <a href="customers/delete/id/{{$item->customer_id}}" class="card-link">حذف</a>
                                                <a href="salary/activity/c/{{$item->customer_id}}/month/{{\App\Http\Controllers\CalendarController::findPackage()}}" class="card-link">فعالیت</a>
                                            </form>
                                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-footer text-center">
                                                            <a href="history/roles/month/{{$history->package}}" class="card-link">لیست نقش ها</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        @endforeach
                                            ...
                                            @foreach(\App\Http\Controllers\SalaryController::monthHistory() as $index=>$history)
                                                <div class="col-md-3">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-footer text-center">
                                                            <a href="history/points/month/{{$history->package}}" class="card-link">جدول امتیازات</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        @endforeach
                                            ...
                                            @foreach(\App\Http\Controllers\SalaryController::monthHistory() as $index=>$history)
                                                <div class="col-md-3">
                                                    <div class="card text-center">
                                                        ...
                                                        <div class="card-footer text-center">
                                                            <a href="salary/table/month/{{$history->package}}" class="card-link">حقوق کارکنان</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        @endforeach
